package com.illdangag.iricom.service.account.group;
...
@Slf4j
@Transactional
public class AccountGroupServiceCreateTestCore extends IricomTestServiceSuite {
    @Autowired
    private AccountGroupService accountGroupService;

    public AccountGroupServiceCreateTestCore(ApplicationContext context) {
        super(context);
    }
